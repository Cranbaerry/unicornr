...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'statusupdatenotification.cancel') {
			Joomla.submitform(task, document.getElementById('statusupdatenotification-form'));
		}
		else {
			...
			if (task != 'statusupdatenotification.cancel' && document.formvalidator.isValid(document.id('statusupdatenotification-form'))) {
				Joomla.submitform(task, document.getElementById('statusupdatenotification-form'));
			}
			else {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="statusupdatenotification-form" class="form-validate form-horizontal">

	
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'statusupdatenotification')); ?>
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'statusupdatenotification', JText::_('COM_UNICORNR_NOTIFICATIONS_TAB_STATUSUPDATENOTIFICATION', true)); ?>
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_UNICORNR_NOTIFICATIONS_FIELDSET_STATUSUPDATENOTIFICATION'); ?></legend>
				<?php echo $this->form->renderField('status_type'); ?>
				...
				<div class="control-group">
					<div class="control-label">
						<label id="jform_messages-lbl" for="jform_messages">
							<?php echo JText::_('COM_UNICORNR_NOTIFICATIONS_FORM_LBL_STATUSUPDATENOTIFICATION_MESSAGE'); ?>
						</label>
					</div>
					<div class="controls">
