 ...
 * @since  1.6
 */
class Unicornr_notificationsModelTransactionnotifications extends \Joomla\CMS\MVC\Model\ListModel
{
...
/**
	...
	*/
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'days_before_reminder', 'a.days_before_reminder',
				'time', 'a.time',
				'message', 'a.message',
			);
		}
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__unicornr_notifications_transactions` AS a');
